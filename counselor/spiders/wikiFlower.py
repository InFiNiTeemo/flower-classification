...
class WiKiSpider(scrapy.Spider):
    urlQueue = Queue()
    name = 'wikipedia_flower_spider'
    allowed_domains = ['zh.wikipedia.org']
    start_urls = ['https://zh.wikipedia.org/wiki/Category:被子植物']  # ['https://zh.wikipedia.org/wiki/Category:被子植物']
    custom_settings = {
    ...
    def parse(self, response):
        # todo simplify this, no need when using start_requests
        """
